                ...
                <div class="col-lg-3">
                    <div class="cat-card">
                        ...
                        <div class="right">
                            <div class="cat-data">
                                <h2>{{ $category->name }}</h2>
                                <p>{{ $category->product->count() }} Products</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row pb-3">
                @foreach ($products as $product )
                    @if ($product->isfeatured == 'yes')
                        <div class="col-md-3">
                            <div class="card product-card">
                                <div class="product-image position-relative">
                                    <a href="{{ route('user.singleproduct', $product->slug) }}" class="product-img"><img class="card-img-top" src="{{ $product->image }}" height="200" alt=""></a>
    ...
    <section class="section-4 pt-5">
        <div class="container">
            ...
            <div class="row pb-3">
                ...
                @foreach ($productlatest as $p )
                     @if ($p->isfeatured == 'yes')

                        <div class="col-md-3">
                            <div class="card product-card">
                                <div class="product-image position-relative">
                                    <a href="{{ route('user.singleproduct', $p->slug) }}" class="product-img"><img class="card-img-top" src="{{ $p->image }}" alt=""></a>
                                    <a class="whishlist" href="222"><i class="far fa-heart"></i></a>
                                ...
                                <div class="card-body text-center mt-3">
                                    <a class="h6 link" href="product.php">{{ $p->name }}</a>
                                    <div class="price mt-2">
                                        <span class="h5"><strong>{{ $p->price }}</strong></span>
                                        @if (!empty($product->oldprice))
                                        <span class="h6 text-underline"><del>{{ $product->oldprice }}</del></span>
                                        @endif
                                    </div>
                ...
                @endforeach
                    ...
                    <a href="{{ route('user.shop') }}" class="btn btn-warning"> <strong>Shopping Now</strong> </a>

				...
				<section class="content">
					...
					<div class="container-fluid">
								...
								<div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="category_id"  class="form-control">
                                            @foreach ($category_status as  $c)
                                            <option @selected($category_status==$c) value="{{ $c }}">{{ $c }}</option>
                                            @endforeach
						...
						<div class="pb-5 pt-3">
							...
							<a type="reset" href="{{ route('category.index') }}" class="btn btn-outline-dark ml-3">Cancel</a>
						</div>
                        </form>
					</div>
					<!-- /.card -->

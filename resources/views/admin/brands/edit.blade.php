								...
								<div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <select name="category_id" id="category" class="form-control">
                                                ...
                                                <option @selected($brand->category_id == $category->id) value="{{ $category->id }}">{{ $category->name }}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="category_id"  class="form-control">
                                            ...
                                            @foreach ($status as  $s)
                                            <option @selected($brand->status == $s) >{{ $s}}</option>
                                            @endforeach
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <img id="previewImage" src="{{ $brand->image  }}" style="max-width: 70px; height: auto;"/>
                                            </div>
                                        </div>
                                    </div>
								</div>
